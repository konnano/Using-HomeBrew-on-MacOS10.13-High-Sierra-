...
2023年12月 freetype、jpeg-xl、php、isl、mysql、z3 などは以下でインストール出来ます
...
2023年12月 node(21.5.0)は llvm@15が無いとインストール出来ないので書き換えが必要になります
...
node(21.5.0) のビルドは llvm@15で大丈夫です、node.rbでビルドに llvmが指定されてるので llvm(17.0.6)が無いないなら
